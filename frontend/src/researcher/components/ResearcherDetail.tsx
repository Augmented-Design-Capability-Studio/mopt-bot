...
export function ResearcherDetail({
  ...
  const tutorialStepLabels: Record<TutorialStepId, string> = {
    ...
    "read-run-summary": "Step 6 - Read run summary",
    "inspect-results": "Step 7 - Look at results",
    "explain-run": "Step 8 - Use Explain",
    "update-config": "Step 9 - Targeted config change",
    "second-run": "Step 10 - Run again",
    "mark-candidate": "Step 11 - Mark as candidate",
    "third-run": "Step 12 - Third run from candidate",
