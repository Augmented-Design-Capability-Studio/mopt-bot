...
Derived from `.cursor` rules, `AI_INSTRUCTIONS.md`, and `README.md`. These rules govern how AI (Antigravity) should approach changes, particularly regarding the modularity of problem instances (`*_problem`), frontend/backend sync, and LLM boundaries.
...
- Simultaneously update `README.md` and `AI_INSTRUCTIONS.md`.
...
1. **Edit this file (`docs/ANTIGRAVITY_RULES.md`)** or **`AI_INSTRUCTIONS.md`** with any new instructions.
