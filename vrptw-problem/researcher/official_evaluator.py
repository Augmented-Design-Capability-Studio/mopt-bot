...
def _cost_contribution(metrics: dict, weights: dict) -> dict[str, float]:
    ...
    return {
        ...
        "fuel": w.get("w2", 0) * metrics.get("fuel_cost", 0),
...
def print_cost_breakdown_comparison(
    ...
    for key, wk, wval, unit in term_info:
        ...
        for _, ev in results:
            ...
            name = {"travel_time": "travel", "fuel_cost": "fuel", "tw_violation_min": "tw_violation",
        ...
        display = {"travel_time": "Travel time", "fuel_cost": "Fuel", "tw_violation_min": "TW violation",
