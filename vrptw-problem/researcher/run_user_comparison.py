...
Run from vrptw-problem/: python -m researcher.run_user_comparison
Or: cd vrptw-problem && python -m researcher.run_user_comparison
"""

import sys
from pathlib import Path

# Add vrptw-problem to path so we can import evaluator, orders, etc.
